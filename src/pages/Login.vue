<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm card-box loginform">
    <div align="center"><img src="../assets/form_logo.png" class="head" /></div>
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
            ...
            requestLogin(loginParams).then(data => {
              ...
              this.logining = false;
              NProgress.done();
              let { access_token, code, refresh_token, user_id, user_account, user_name, msg} = data;
