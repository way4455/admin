	...
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			<el-col :span="20" style="font-size:26px;">
				<img src="../assets/form_logo.png" class="logo">
			</el-col>
	...
	export default {
		...
		mounted() {
			...
			if (user) {
				...
				this.sysUserAvatar = userLogo;//'assets/user.png';//'https://raw.githubusercontent.com/taylorchen709/markdown-images/master/vueadmin/user.png';
			}
		}
	}
